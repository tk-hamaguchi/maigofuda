...
RSpec.describe Maigofuda::LockedError do
  ...
  its(:status_code) { is_expected.to eq 423 }
  ...
  describe '#error_code' do
    ...
    context 'when error_code_table => { "Maigofuda::LockedError" => "U123" }' do
      let(:error_code_table) { { 'Maigofuda::LockedError' => 'U123' } }
  ...
  describe '#localized_message' do
    ...
    context 'without args' do
      ...
      context 'when "en.maigofuda.error_messages.maigofuda.locked_error" => "Hoge"' do
        let(:translations) { { maigofuda: { error_messages: { maigofuda: { locked_error: 'Hoge' } } } } }
