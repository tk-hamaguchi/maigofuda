...
RSpec.describe Maigofuda::InternalServerError do
  ...
  describe '#error_code' do
    ...
    context 'when error_code_table => { "Maigofuda::InternalServerError" => "U123" }' do
      let(:error_code_table) { { 'Maigofuda::InternalServerError' => 'U123' } }
  ...
  describe '#localized_message' do
    ...
    context 'without args' do
      ...
      context 'when "en.maigofuda.error_messages.maigofuda.internal_server_error" => "Hoge"' do
        let(:translations) { { maigofuda: { error_messages: { maigofuda: { internal_server_error: 'Hoge' } } } } }
