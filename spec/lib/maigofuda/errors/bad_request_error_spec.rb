...
RSpec.describe Maigofuda::BadRequestError do
  ...
  its(:status_code) { is_expected.to eq 400 }
  ...
  describe '#error_code' do
    ...
    context 'when error_code_table => { "Maigofuda::BadRequestError" => "U123" }' do
      let(:error_code_table) { { 'Maigofuda::BadRequestError' => 'U123' } }
  ...
  describe '#localized_message' do
    ...
    context 'without args' do
      ...
      context 'when "en.maigofuda.error_messages.maigofuda.bad_request_error" => "Hoge"' do
        let(:translations) { { maigofuda: { error_messages: { maigofuda: { bad_request_error: 'Hoge' } } } } }
