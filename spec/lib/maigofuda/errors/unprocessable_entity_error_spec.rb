...
RSpec.describe Maigofuda::UnprocessableEntityError do
  ...
  describe '#error_code' do
    ...
    context 'when error_code_table => { "Maigofuda::UnprocessableEntityError" => "U123" }' do
      let(:error_code_table) { { 'Maigofuda::UnprocessableEntityError' => 'U123' } }
  ...
  describe '#localized_message' do
    ...
    context 'without args' do
      ...
      context 'when "en.maigofuda.error_messages.maigofuda.unprocessable_entity_error" => "Hoge"' do
        let(:translations) { { maigofuda: { error_messages: { maigofuda: { unprocessable_entity_error: 'Hoge' } } } } }
