...
RSpec.describe Maigofuda::ConflictError do
  ...
  its(:status_code) { is_expected.to eq 409 }
  ...
  describe '#error_code' do
    ...
    context 'when error_code_table => { "Maigofuda::ConflictError" => "U123" }' do
      let(:error_code_table) { { 'Maigofuda::ConflictError' => 'U123' } }
  ...
  describe '#localized_message' do
    ...
    context 'without args' do
      ...
      context 'when "en.maigofuda.error_messages.maigofuda.conflict_error" => "Hoge"' do
        let(:translations) { { maigofuda: { error_messages: { maigofuda: { conflict_error: 'Hoge' } } } } }
