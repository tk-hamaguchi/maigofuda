...
RSpec.describe Maigofuda::NotFoundError do
  ...
  its(:status_code) { is_expected.to eq 404 }
  ...
  describe '#error_code' do
    ...
    context 'when error_code_table => { "Maigofuda::NotFoundError" => "U123" }' do
      let(:error_code_table) { { 'Maigofuda::NotFoundError' => 'U123' } }
  ...
  describe '#localized_message' do
    ...
    context 'without args' do
      ...
      context 'when "en.maigofuda.error_messages.maigofuda.not_found_error" => "Hoge"' do
        let(:translations) { { maigofuda: { error_messages: { maigofuda: { not_found_error: 'Hoge' } } } } }
